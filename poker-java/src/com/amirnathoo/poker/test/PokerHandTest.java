...
class PokerHandTest {
	...
	Card singlePair[] = { new Card(Card.A, Card.CLUB), new Card(Card.A, Card.HEART), new Card(Card.Two, Card.DIAMOND),
			new Card(Card.J, Card.SPADE), new Card(Card.Five, Card.CLUB) };

	Card doublePairs[] = { new Card(Card.A, Card.CLUB), new Card(Card.A, Card.HEART), new Card(Card.Q, Card.DIAMOND),
			new Card(Card.Q, Card.SPADE), new Card(Card.Five, Card.CLUB) };

	Card threeOfAKind[] = { new Card(Card.A, Card.CLUB), new Card(Card.Q, Card.HEART), new Card(Card.Q, Card.DIAMOND),
			new Card(Card.Q, Card.SPADE), new Card(Card.Five, Card.CLUB) };

	Card fourOfAKind[] = { new Card(Card.A, Card.CLUB), new Card(Card.Q, Card.HEART), new Card(Card.Q, Card.DIAMOND),
			new Card(Card.Q, Card.SPADE), new Card(Card.Q, Card.CLUB) };

	Card straight[] = { new Card(Card.Nine, Card.CLUB), new Card(Card.Eight, Card.HEART),
			new Card(Card.Seven, Card.DIAMOND), new Card(Card.Six, Card.SPADE), new Card(Card.Five, Card.CLUB) };

	Card flush[] = { new Card(Card.K, Card.HEART), new Card(Card.Q, Card.HEART), new Card(Card.Two, Card.HEART),
			new Card(Card.A, Card.HEART), new Card(Card.J, Card.HEART) };

	Card straightFlush[] = { new Card(Card.Ten, Card.HEART), new Card(Card.Nine, Card.HEART),
			new Card(Card.Eight, Card.HEART), new Card(Card.Seven, Card.HEART), new Card(Card.Six, Card.HEART) };

	Card royalFlush[] = { new Card(Card.Ten, Card.CLUB), new Card(Card.K, Card.CLUB), new Card(Card.Q, Card.CLUB),
			new Card(Card.J, Card.CLUB), new Card(Card.A, Card.CLUB) };

	Card fullHouse[] = { new Card(Card.K, Card.CLUB), new Card(Card.K, Card.SPADE), new Card(Card.Six, Card.CLUB),
			new Card(Card.Six, Card.DIAMOND), new Card(Card.Six, Card.HEART) };

	Card highCard[] = { new Card(Card.K, Card.HEART), new Card(Card.Two, Card.HEART), new Card(Card.Five, Card.CLUB),
			new Card(Card.Three, Card.SPADE), new Card(Card.Six, Card.DIAMOND) };

	@DisplayName("Creates a poker hand with 5 cards")
	@Test
	void createAPokerHand() {

		Card cards[] = { new Card(Card.A, Card.CLUB), new Card(Card.A, Card.HEART), new Card(Card.Two, Card.DIAMOND),
				new Card(Card.J, Card.SPADE), new Card(Card.Five, Card.CLUB) };
